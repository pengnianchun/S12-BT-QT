...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        if (cmdListTableWidget->rowCount() < 10)
        ...
        executeFirmwarePushButton->setMinimumSize(QSize(80, 0));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "S12 USB-CAN Bootloader", Q_NULLPTR));
        ...
        ___qtablewidgetitem33->setText(QApplication::translate("MainWindow", "CmdSuccess", Q_NULLPTR));
